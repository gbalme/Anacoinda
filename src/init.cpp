...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Anacoinda version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  Anacoindad [options]                     " + "\n" +
                  "  Anacoindad [options] <command> [params]  " + _("Send command to -server or Anacoindad") + "\n" +
                  "  Anacoindad [options] help                " + _("List commands") + "\n" +
                  "  Anacoindad [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: Anacoinda.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: Anacoindad.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 56780 or testnet: 46780)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 56789 or testnet: 46789)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (fDaemon)
        fprintf(stdout, "Anacoinda server starting\n");
